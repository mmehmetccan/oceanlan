...
const CreateServerModal = ({ onClose, createServer, onCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // createServer fonksiyonu (Context'teki) zaten fetch işlemini yapıyor
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="create-server-form">
          <input type="text" placeholder="Yeni sunucu adı" value={name} onChange={(e) => setName(e.target.value)} disabled={loading} />
